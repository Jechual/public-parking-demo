...
class ParkingsControllerTest < ActionController::TestCase
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post :create, parking: { ciudad: @parking.ciudad, codigo: @parking.codigo, direccion: @parking.direccion, nombre: @parking.nombre }
    end
  ...
  test "should update parking" do
    patch :update, id: @parking, parking: { ciudad: @parking.ciudad, codigo: @parking.codigo, direccion: @parking.direccion, nombre: @parking.nombre }
    assert_redirected_to parking_path(assigns(:parking))
  end
